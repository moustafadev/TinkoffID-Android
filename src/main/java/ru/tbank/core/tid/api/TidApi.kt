...
internal class TidApi(
    ...
    companion object {
        ...
        private const val PARAM_DEFAULT_VENDOR = "t_android"
        ...
        fun createTidApi(
            ...
            val okHttpClient = OkHttpClient.Builder()
                .enrichWithTrustedCerts(context, TargetStandRootCertsProvider())
        ...
        fun buildWebViewAuthStartUrl(
            ...
            return Uri.parse(host).buildUpon()
                ...
                .apply {
                    ...
                    if (phone != null) {
                        appendQueryParameter(FIELD_PHONE, phone)
                    }
                }
                .build()
                .toString()
